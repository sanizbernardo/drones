 ...
 */
public class TestWorld2 implements IWorldRules {
...
//        AutopilotConfig config = configSetup.showDialog();
        ...
        drone.setThrust(20f);
        drone.setVelocity(new BasicVector(new double[]{0, 0, -40}));
        drone.setLeftWingInclination((float)Math.toRadians(5));
        drone.setRightWingInclination((float)Math.toRadians(5));
        drone.setHorStabInclination(0f);
