...
public class GuiUtils {
	...
	public static BufferedImage addCrossHair(BufferedImage img, int imgx, int imgy, int color) {
	...
	public static JSpinner buildSpinner(JPanel parentPanel, String lblName, int xpos, int ypos, Number defaultValue, Comparable<?> min, Comparable<?> max,  Number stepSize) {
